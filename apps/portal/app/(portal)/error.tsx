...
export default function PortalError({
  ...
  return (
    <section role="alert" aria-labelledby="portal-error-title" className="mx-auto max-w-2xl rounded-2xl border border-line bg-surface p-5 shadow-card sm:p-7">
      <p className="text-[10px] font-semibold uppercase tracking-[0.16em] text-ink-4">KSP OS · Portal</p>
      <h1 id="portal-error-title" className="mt-2 text-xl font-semibold text-ink sm:text-2xl">We could not load this page.</h1>
      <p className="mt-2 max-w-xl text-[13px] leading-relaxed text-ink-3 sm:text-sm">
        Nothing on this screen should be treated as submitted or approved until the page loads successfully.
      </p>
