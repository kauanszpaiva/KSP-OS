...
insert into documents (id, organization_id, client_id, title, storage_path, classification, client_visible, status) values
  ...
  ('60000000-0000-0000-0000-000000000007', '10000000-0000-0000-0000-000000000001', '30000000-0000-0000-0000-000000000001', 'managed-client-upload-denied', '10000000-0000-0000-0000-000000000001/60000000-0000-0000-0000-000000000007/portal-upload.txt', 'public', true, 'active');
...
begin;
  ...
  do $$ declare c int; begin
    ...
    begin
      insert into storage.objects (bucket_id, name)
      values ('managed-files', '10000000-0000-0000-0000-000000000001/60000000-0000-0000-0000-000000000007/portal-upload.txt');
