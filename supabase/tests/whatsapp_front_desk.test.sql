-- KSP INC WhatsApp AI Front Desk V1 actor and channel-scope matrix.
...
insert into public.communication_channels(
 id,organization_id,channel_key,kind,provider,address,status,inbound_enabled,outbound_enabled,created_by
) values (
 'b2000000-0000-0000-0000-000000000001','b0000000-0000-0000-0000-000000000001',
 'owner-whatsapp','whatsapp','meta','+15555550100','configured',true,true,'b1000000-0000-0000-0000-000000000001'
);
...
insert into public.communication_conversations(
 id,organization_id,scope,primary_channel,state,assigned_agent_key
) values (
