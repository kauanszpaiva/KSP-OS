...
- **Production:** `https://www.appkspdominion.com/api/mcp`
...
3. **URL:** `https://www.appkspdominion.com/api/mcp`
...
2. **Add** a connector by **URL:** `https://www.appkspdominion.com/api/mcp`.
